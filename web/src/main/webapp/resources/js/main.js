...
function redrawSeat(seat){
    ...
    context.closePath();
    context.shadowColor = '#464141';
    context.shadowBlur = 50;
    context.lineWidth = 1;
    context.fillStyle = '#d4bf9e';
    context.fill();
    context.strokeStyle = '#989288';
    context.stroke();
}
...
jQuery(function($){
  $("#slider-bottom").pathslider({
    ...
    tolerance  : 3,
    range      : 30,
    curve      : { width:4, color:"#ccc", cap:"round" },
  ...
  $("#slider-bottom .pathslider-grip").hover(function(){
      $('#image-container > img').show().attr('src', 'img/bottom.png');
  });
  ...
  $("#slider-top .pathslider-grip").hover(function(){
      $('#image-container > img').show().attr('src', 'img/top.png');
  });
  ...
  $("#slider-header-h .pathslider-grip").hover(function(){
      $('#image-container > img').show().attr('src', 'img/header-h.png');
  });
  ...
  $("#slider-header-v .pathslider-grip").hover(function(){
      $('#image-container > img').show().attr('src', 'img/header-v.png');
  });
  ...
  $("#slider-middle-h .pathslider-grip").hover(function(){
      $('#image-container > img').show().attr('src', 'img/middle-h.png');
  });    
  ...
  $("#slider-middle-v .pathslider-grip").hover(function(){
      $('#image-container > img').show().attr('src', 'img/middle-v.png');
  });
  ...
  $("#slider-bottom-h .pathslider-grip").hover(function(){
      $('#image-container > img').show().attr('src', 'img/bottom-h.png');
  });
  ...
  $("#slider-bottom-v-head .pathslider-grip").hover(function(){
      $('#image-container > img').show().attr('src', 'img/bottom-v-head.png');
  });
  ...
  $("#slider-bottom-v-tail .pathslider-grip").hover(function(){
      $('#image-container > img').show().attr('src', 'img/bottom-v-tail.png');
  });
